...
def test_value_fusion():
    ...
    combined_specs = {
        ...
        "Panel": "IPS",
        "Form": "gerade",
        "Beschichtung": "SUPER + Resolution, Multiscan Support, integrierte Kabelführung, Reihenschaltung möglich, "
        "Crosshair Display, Flicker Safe, Reader Mode, 6-Achsen-Farbanpassung, Intelligente "
        "Energiespartechnologie, Black Stabilizer, DAS Mode (Dynamic Action Sync), Color Weakness "
        "Mode, Mega DFC, One Click Stand, nahezu rahmenloses Display an 3 Seiten",
        "Seitenverhältnis": {"width": "16", "height": "9"},
        "Farbtiefe": {"value": "8", "unit": "bit"},
        "Bildwiederholfrequenz": {"value": "75", "unit": "Hz"},
        "Anschlüsse Klinke": {"count": "1", "type": "Line-Out"},
